            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  onChange={(event) => {
                    if (event.target.value.toLowerCase() == "вовчик" ||
                        event.target.value.toLowerCase() == "вова" ||
                        event.target.value.toLowerCase() == "владимир"
                    ) {
                      event.target.value = "Такого имени не существует";
                    }
                  }}
                  required
                />
